...
def main():
    parser = argparse.ArgumentParser(description="--- ICU MLOps Pipeline Orchestrator ---")
    parser.add_argument("--step", type=str, choices=["data", "features", "train", "monitor", "test", "all"], 
    ...
    steps = {
        "data": ("python src/data_processing.py", "Data Processing (Loading & Cleaning)"),
        "features": ("python src/features.py", "Feature Engineering (Sliding Window & Labeling)"),
        "validate": ("python src/data_validation.py", "Data Consistency & Range Validation"),
